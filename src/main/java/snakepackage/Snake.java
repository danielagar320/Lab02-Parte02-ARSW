    ...
    private void checkIfBarrier(Cell newCell) {
        if (Board.gameboard[newCell.getX()][newCell.getY()].isBarrier()) {
            ...
            System.out.println("[" + idt + "] " + "CRASHED AGAINST BARRIER "
                    + newCell.toString());
            snakeEnd=true;
            deadOrder= Board.ordenMuerte.getAndIncrement();
        }
    }
...
//        }
    ...
    /**
     * Metodo encargado de traer el orden en que la serpiente murio
     * @return int
     */
    ...
    /**
     * Metodo encargado de dar la cantidad de celdas del cuerpo de la serpiente
